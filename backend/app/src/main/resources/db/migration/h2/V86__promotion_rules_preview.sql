CREATE TABLE IF NOT EXISTS promotion_rules (
    ...
    CONSTRAINT fk_promotion_rules_promotion FOREIGN KEY (promotion_id) REFERENCES venue_promotions(id) ON DELETE CASCADE,
    CONSTRAINT fk_promotion_rules_venue FOREIGN KEY (venue_id) REFERENCES venues(id) ON DELETE CASCADE,
    CONSTRAINT fk_promotion_rules_user FOREIGN KEY (created_by_user_id) REFERENCES users(telegram_user_id) ON DELETE RESTRICT,
    CHECK (
