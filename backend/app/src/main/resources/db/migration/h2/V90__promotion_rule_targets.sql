CREATE TABLE IF NOT EXISTS promotion_rule_targets (
    ...
    CONSTRAINT fk_promotion_rule_targets_rule FOREIGN KEY (rule_id) REFERENCES promotion_rules(id) ON DELETE CASCADE,
    CONSTRAINT fk_promotion_rule_targets_menu_item FOREIGN KEY (menu_item_id) REFERENCES menu_items(id) ON DELETE CASCADE,
    CHECK (
