...
ALTER TABLE staff_calls
    ADD CONSTRAINT IF NOT EXISTS fk_staff_calls_order
    FOREIGN KEY (order_id) REFERENCES orders(id) ON DELETE SET NULL;

ALTER TABLE staff_calls
    ADD CONSTRAINT IF NOT EXISTS fk_staff_calls_tab
    FOREIGN KEY (tab_id) REFERENCES tab(id) ON DELETE SET NULL;

ALTER TABLE staff_calls
    ADD CONSTRAINT IF NOT EXISTS chk_staff_calls_payment_method
