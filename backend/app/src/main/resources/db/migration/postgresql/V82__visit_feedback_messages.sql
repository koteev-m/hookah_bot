CREATE TABLE IF NOT EXISTS visit_feedback_messages (
    ...
    feedback_id BIGINT NOT NULL REFERENCES visit_feedback(id) ON DELETE CASCADE,
    ...
    sender_type VARCHAR(32) NOT NULL CHECK (sender_type IN ('STAFF', 'GUEST')),
    sender_user_id BIGINT NULL REFERENCES users(telegram_user_id) ON DELETE SET NULL,
    message_text TEXT NOT NULL,
    delivered_at TIMESTAMPTZ NULL,
    staff_chat_notified_at TIMESTAMPTZ NULL,
