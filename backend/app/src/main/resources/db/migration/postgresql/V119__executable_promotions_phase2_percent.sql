...
ALTER TABLE promotion_rules
    ADD CONSTRAINT chk_promotion_rules_executable_target_type
...
ALTER TABLE order_promotion_applications
    ADD COLUMN IF NOT EXISTS schedule_snapshot_json TEXT;

ALTER TABLE order_promotion_applications
    ADD COLUMN IF NOT EXISTS target_snapshot_json TEXT;
