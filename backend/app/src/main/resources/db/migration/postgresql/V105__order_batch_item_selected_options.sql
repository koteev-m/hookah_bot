CREATE TABLE IF NOT EXISTS order_batch_item_options (
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_order_batch_item_options_item
    ON order_batch_item_options (order_batch_item_id);

CREATE INDEX IF NOT EXISTS idx_order_batch_item_options_option
