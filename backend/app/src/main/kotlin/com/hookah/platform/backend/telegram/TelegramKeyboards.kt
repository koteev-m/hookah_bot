...
object TelegramKeyboards {
    fun mainMenu(hasVenueRole: Boolean, isPlatformOwner: Boolean, webAppUrl: String?): ReplyKeyboardMarkup {
    ...
    fun tableContext(context: TableContext, webAppUrl: String?): ReplyKeyboardMarkup {
    ...
    fun inlineConfirmQuickOrder(): InlineKeyboardMarkup = InlineKeyboardMarkup(
    ...
    fun inlineStaffCallReasons(): InlineKeyboardMarkup = InlineKeyboardMarkup(
        inlineKeyboard = listOf(
    ...
    fun inlineOpenActiveOrder(webAppUrl: String?, tableToken: String): InlineKeyboardMarkup? {
    ...
    fun inlineOpenMenu(webAppUrl: String?, tableToken: String): InlineKeyboardMarkup? {
        val url = webAppUrl ?: return null
        return InlineKeyboardMarkup(
            inlineKeyboard = listOf(
                listOf(
