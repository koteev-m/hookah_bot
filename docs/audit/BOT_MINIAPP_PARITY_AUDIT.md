...
- venue hours/date exceptions remain the selected active parity gap after M9a because Mini App settings and direct guest booking validation do not yet use the Bot/backend schedule model;
