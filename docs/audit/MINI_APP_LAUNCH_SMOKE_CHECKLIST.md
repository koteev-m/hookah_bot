...
- Venue Mini App Published Guest Preview Phase 1 is **DONE / MVP / STAGING-SMOKE-PASSED**: OWNER/MANAGER open `Предпросмотр карточки`; the unchanged Guest venue/info assembly produced exact real-Guest parity, STAFF/foreign access was denied, venue switching stayed isolated and no guest mutations were exposed. GitHub Actions were green and staging deploy/smoke passed.
