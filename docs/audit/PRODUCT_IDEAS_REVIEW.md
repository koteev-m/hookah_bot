...
> STAGING-SMOKE-PASSED**. Guest source is still `MANUAL`; Schedule alone does not publish staff or
> expose future/full schedule. Optional Team/Schedule enablement plus Guest `MANUAL`/`SCHEDULE`
> selection is the separate next Slice B. Staff photo/media, tips/payments, recurring shifts,
