...
Venue Owner - главный владелец конкретного заведения. Он управляет карточкой, заказным меню, столами/QR, персоналом, staff chat, бронями, промо и операционными заказами. Platform Owner права не выдаются автоматически.
