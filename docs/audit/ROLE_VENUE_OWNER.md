...
- Telegram fallback/staff-chat spec is `UPDATED` in `docs/TELEGRAM_FALLBACK_STAFF_CHAT.md`: Owner staff-chat link/test/unlink, Telegram operational menus, callback RBAC and notification allow/deny policy are canonical.
