...
- Staff profiles, Today Shift, optional Staff Schedule and future staff tips are canonical in
  ...
  this is local implementation evidence, not Actions, staging or manual-smoke evidence. Phase 2 may add
...
MVP IMPLEMENTED / LOCAL VALIDATION PASSED / REVIEW REQUIRED BEFORE COMMIT`; its Actions, staging
deploy and manual smoke are not yet claimed. Telegram, reminders, recurring/split shifts, mass edit,
