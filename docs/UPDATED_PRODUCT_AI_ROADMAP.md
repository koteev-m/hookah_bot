...
Recommended next block: `P1 Paid venue/shift extension` product/API design pack, because the remaining closed smoke state leaves this as the highest-priority Guest/Venue operational gap before moving deeper into P2 polish.
